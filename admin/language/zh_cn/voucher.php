...
$lang['admin_voucher_unavailable']    = '需开启 消费券、积分，正在跳转到设置页面 。。。';
...
//菜单
$lang['admin_voucher_apply_manage']= '服务申请管理';
$lang['admin_voucher_quota_manage']= '营销管理';
$lang['admin_voucher_template_manage']= '店铺消费券';
$lang['admin_voucher_template_edit']= '编辑消费券';
...
$lang['admin_voucher_setting_buyertimes_tip']	= '买家最多只能拥有同一个店铺尚未消费抵用的店铺消费券最大数量';
//$lang['admin_voucher_setting_default_styleimg']	= '消费券默认样式模板';
/**
 * 消费券面额
 */
$lang['admin_voucher_price_error']   		= '消费券面额应为大于0的整数';
$lang['admin_voucher_price_describe_error'] = '描述不能为空';
$lang['admin_voucher_price_describe_lengtherror'] = '消费券描述不能为空且不能大于255个字符';
$lang['admin_voucher_price_points_error']   = '默认兑换积分数应为大于0的整数';
$lang['admin_voucher_price_exist']    		= '该消费券面额已经存在';
$lang['admin_voucher_price_title']    		= '消费券面额';
$lang['admin_voucher_price_describe']    	= '描述';
$lang['admin_voucher_price_points']    		= '兑换积分数';
$lang['admin_voucher_price_points_tip']    	= '当兑换消费券时，消耗的积分数';
$lang['admin_voucher_price_tip1']    	= '管理员规定消费券面额，店铺发放消费券时面额从规定的面额中选择';
/**
 * 消费券服务申请
 */
$lang['admin_voucher_apply_goldnotenough']	= '该会员金币不够，操作失败';
$lang['admin_voucher_apply_goldlog']    	= '购买消费券活动%s个月，单价%s金币，总共花费%s金币';
$lang['admin_voucher_apply_message']    	= '您成功购买消费券活动%s个月，单价%s金币，总共花费%s金币，时间从审核后开始计算';
$lang['admin_voucher_apply_verifysucc']    	= '申请审核成功，活动服务已经发放';
...
$lang['admin_voucher_apply_list_tip1']    	= '对卖家的服务申请进行审核，审核后系统会使用站内信通知卖家';
$lang['admin_voucher_apply_list_tip2']    	= '当卖家金币不足时审核会失败，卖家发布成功的消费券会出现在积分中心，买家可凭积分进行兑换';
$lang['admin_voucher_apply_num']    		= '申请数量';
$lang['admin_voucher_apply_date']    		= '申请日期';
/**
 * 消费券服务
 */
$lang['admin_voucher_quota_cancelsucc']    	= '服务取消成功';
$lang['admin_voucher_quota_cancelfail']    	= '服务取消失败';
...
$lang['admin_voucher_template_title']			= '消费券名称';
...
$lang['admin_voucher_template_describe']		= '消费券描述';
$lang['admin_voucher_template_styleimg']		= '选择消费券皮肤';
$lang['admin_voucher_template_image']			= '消费券图片';
$lang['admin_voucher_template_points']			= '兑换所需积分数';
$lang['admin_voucher_template_adddate']			= '添加时间';
$lang['admin_voucher_template_list_tip']		= '手工设置消费券失效后,用户将不能领取该消费券,但是已经领取的消费券仍然可以使用';
