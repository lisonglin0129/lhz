 ...
 * 模板页  
 */
$lang['index_index_store_goods_price']		= '供货价';
...
$lang['web_config_edit_help3']			= '中部的“商品推荐模块”由于页面宽度只能加4个，商品数为8个；右侧的品牌最多为12个(已选择的可以拖动进行排序，单击选中，双击删除)。如果左侧及右侧均没有广告图，中部的“商品推荐模块显示整行，商品数最多为14个';
...
$lang['web_config_recommend_goods_tips']			= '小提示：单击查询出的商品选中，双击已选择的可以删除，最多8或14个，保存后生效。';
