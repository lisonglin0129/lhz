  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);"  class="current"><span><?php echo '平台介入列表';?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center">
        	<?php switch ($val['is_admin_chcked']) {
        		case 1 : {
        			 echo '待审核';
        			 break;
        		}
        ...
        <td class="align-center">
        	<!-- 打款 -->
        	<?php if($val['is_admin_chcked'] == 2){ ?>
            <a href="index.php?act=refund&op=pay_refund&return_id=<?php echo $val['refund_id']; ?>">打款 </a>
       	 		<a href="index.php?act=refund&op=shut_refund&return_id=<?php echo $val['refund_id']; ?>">终结此单 </a>
      	    <?php } ?>
      	    <a href="index.php?act=refund&op=view&return_id=<?php echo $val['refund_id']; ?>"> <?php echo $lang['nc_view'];?> </a>
        </td>
      </tr>
      <?php } ?>
    </tbody>
