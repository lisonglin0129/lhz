          ...
          <li class="picture">
            <div class="size-64x64">
              <span class="thumb">
                <i></i>
				<?php if($v['apic_cover'] != ''){ ?>
				<a nctype="nyroModal"  href="<?php echo cthumb($v['apic_cover'], 1280, $v['store_id']);?>" rel="gal">
				<img title="<?php echo date('Y-m-d',$v['upload_time']);?><?php echo $v['apic_spec'];?>px<br/><?php echo number_format($v['apic_size']/1024,2);?>k" width="64" height="64"  class="tip" src="<?php echo cthumb($v['apic_cover'], 60, $v['store_id']);?>"></a>
				<?php }else{?>
