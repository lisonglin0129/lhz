  ...
  <body>
    <div class='right'>
      <dl class='input' id='form'>
        <form method="post" action="/admin/index.php?act=mobile_timplate&op=update">
          <dt><span>名称</span></dt>
          <dd><input type='text' name='name' value='<?php if($output['data']){echo $output['data']['name'];}?>'></dd>
          <dt><span>链接地址</span></dt>
          <dd><input type='text' name='url' value='<?php if($output['data']){echo $output['data']['url'];}?>'></dd>
          <dt><span>是否开启</span></dt>
          <?php if($output['data'] && $output['data']['off'] == 1){?>
          ...
          <?php }else{?>
          <dd><span>开启</span><input type='radio' name='off' class='radio' value='1'><span>关闭</span><input type='radio' name='off' class='radio' value='0' checked></dd>
          <?php }?>
