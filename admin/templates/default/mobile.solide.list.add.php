<form action='/admin/index.php?act=mobile_timplate&op=addSolide&submit=1' method='post'  enctype="multipart/form-data">
	<table>
		...
		<tr style="height:40px;">
			<td>文件 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='file' name='upload_file'/>（文件像素345px * 194px）</td>
		</tr>
		<tr style="height:40px;">
