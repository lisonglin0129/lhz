    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover edit">
		  ...
		  <a href="index.php?act=brand&op=brand_edit&brand_id=<?php echo $v['brand_id']?>"><?php echo $lang['nc_edit'];?></a>
		 |<a href="index.php?act=brand&op=brand_apply_set&state=pass&brand_id=<?php echo $v['brand_id']?>"><?php echo $lang['nc_pass'];?></a>
