...
<div class="page">
  ...
  <form id="user_form" enctype="multipart/form-data" method="post" action="/admin/index.php?act=mobile_catgroy&op=upd&">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder" style="background: rgb(255, 255, 255) none repeat scroll 0% 0%;">
          <td class="vatop rowform"><input value="<?php echo $output['data'][0]['catgroy_name'];?>" name="name" id="name" class="txt" type="text"></td>
        ...
        <tr class="noborder" style="background: rgb(255, 255, 255) none repeat scroll 0% 0%;">
          <td class="vatop rowform"><ul>
              <?php if($output['data'][0]['catgroy_state'] == 1 ){?>
                <li>
                  <label>
              ...
              <?php }else{?>
                <li>
                  <label>
                    <input value="1" name="state" type="radio">
                    显示</label>
                </li>
                <li>
                  <label>
                    <input checked="checked" value="2" name="state" type="radio">
                    隐藏</label>
                </li>
              <?php }?>
              <input type="hidden" name="mobile_catgroy_id" value="<?php echo $output['data'][0]['mobile_catgroy_id'];?>"/>
            </ul></td>
          <td class="vatop tips"></td>
        </tr>
        <tr style="background: rgb(255, 255, 255) none repeat scroll 0% 0%;">
        ...
        <tr class="noborder" style="background: rgb(255, 255, 255) none repeat scroll 0% 0%;">
          <td class="vatop rowform">
            ...
            <span class="type-file-box">
              <input name="member_avatar" id="member_avatar" class="type-file-text" type="text" value="<?php echo $output['data'][0]['catgroy_logo'];?>">
              <input name="button" id="button" value="" class="type-file-button" type="button">
              <input name="_pic" class="type-file-file" id="_pic" size="30" hidefocus="true" type="file" value="<?php echo $output['data'][0]['catgroy_logo'];?>">
            </span>
            </td>
