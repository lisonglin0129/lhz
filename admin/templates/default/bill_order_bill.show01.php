...
<div class="fixed-empty"></div>  
    <table class="table tb-type2 noborder search">
      ...
      <a class="btns" onclick="if (confirm('审核后将无法撤销，进入下一步付款环节，确认审核吗?')){return true;}else{return false;}" href="index.php?act=bill&op=bill_check&ob_no=<?php echo $_GET['ob_no'];?>">
      	<span><?php echo $lang['nc_exdport'];?>审核</span>
      </a>
