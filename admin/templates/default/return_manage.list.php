  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=return&op=return_terrace"><span><?php echo '平台介入列表';?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center">
        	<a href="index.php?act=return&op=pay_return&return_id=<?php echo $val['refund_id']; ?>">确认</a><br/>
          <a href="index.php?act=return&op=view&return_id=<?php echo $val['refund_id']; ?>">查看</a>
       </td>
      </tr>
      <?php } ?>
    </tbody>
