    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
		  ...
		  <tr class="noborder">
          <td colspan="2" class="required"><label>新品审核（条形码为新的）:</label></td>
        </tr>
		  <tr class="noborder">
          <td class="vatop rowform onoff"><label for="rewrite_enabled1"  class="cb-enable <?php if($output['list_setting']['goods_newverify'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_yes'];?>"><span><?php echo $lang['nc_yes'];?></span></label>
            <label for="rewrite_disabled1" class="cb-disable <?php if($output['list_setting']['goods_newverify'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_no'];?>"><span><?php echo $lang['nc_no'];?></span></label>
            <input id="rewrite_enabled1" name="goods_newverify" <?php if($output['list_setting']['goods_newverify'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">
            <input id="rewrite_disabled1" name="goods_newverify" <?php if($output['list_setting']['goods_newverify'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio"></td>
          <td class="vatop tips">
            <?php echo $lang['open_rewrite_tips'];?></td>
        </tr>
      </tbody>
