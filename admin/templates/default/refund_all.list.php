  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <!-- <li><a href="index.php?act=refund&op=refund_terrace"><span><?php echo '平台介入列表';?></span></a></li>    -->
      </ul>
    </div>
  </div>
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><?php echo $val['seller_state']==2 ? $output['admin_array'][$val['refund_state']]:'未打款'; ?></td>
        <td class="align-center"><a href="index.php?act=refund&op=view&return_id=<?php echo $val['refund_id']; ?>"> <?php echo $lang['nc_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
