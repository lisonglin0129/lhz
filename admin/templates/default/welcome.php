  ...
  <div class="info-panel">
    ...
    <dl class="trade">
      ...
      <dd>
        ...
        <li class="w20pre none"><a href="/admin/index.php?act=return&op=return_terrace"><?php echo $lang['dashboard_wel_complain_handle'];?><sub><em id="statistics_complain_handle_list">0</em></sub></a></li>
        </ul>
      </dd>
    </dl>
    <dl class="operation">
