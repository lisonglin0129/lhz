      ...
      <tbody>
        <tr>
          ...
          <td><select name="search_state" >
              ...
              <option <?php if($_GET['search_state'] == 'no_ischeck'){ ?>selected='selected'<?php } ?> value="no_ischeck">资料未审核</option>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover member">
		  ...
		  <td class="align-center"><?php echo $v['is_check'] >0?'已审核':'未审核' ?></td>
