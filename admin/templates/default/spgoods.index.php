      ...
      <tbody id="treet1">
        ...
        <tr class="hover edit row">
          ...
          <td class="align-center">
          	<a href="index.php?act=spgoods&op=edit&activity_id=<?php echo $v['activity_id'];?>"><?php echo $lang['nc_edit'];?></a>&nbsp;|&nbsp;
          	<?php if ($v['activity_state'] == 0 || $v['activity_end_date']<time()){?>
          	<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=spgoods&op=del&activity_id=<?php echo $v['activity_id'];?>';}"><?php echo $lang['nc_del'];?></a>&nbsp;|&nbsp;
          	<?php }?>
          	<a href="index.php?act=spgoods&op=detail&id=<?php echo $v['activity_id'];?>"><?php echo $lang['activity_index_deal_apply'];?></a>
          </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
