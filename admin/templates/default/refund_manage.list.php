  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><a href="index.php?act=refund&op=view&return_id=<?php echo $val['refund_id']; ?>"> <?php echo $lang['nc_view'];?> </a><a href="index.php?act=refund&op=pay_refund&return_id=<?php echo $val['refund_id']; ?>">打款 </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
