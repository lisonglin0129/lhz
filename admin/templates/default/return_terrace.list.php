      ...
      <tr class="bd-line" >
        ...
        <td class="align-center">
        	...
        	<?php if($val['is_admin_chcked'] == 2){ ?>
       	 		<a href="index.php?act=return&op=pay_return&return_id=<?php echo $val['refund_id']; ?>">打款 </a>
       	 		<a href="index.php?act=return&op=shut_return&return_id=<?php echo $val['refund_id']; ?>">终结此单 </a>
      	    <?php } ?>
