      ...
      <tbody>
        ...
        <tr class="noborder" >
          <td class="vatop rowform"><select name="activity_type" id="activity_type">
              <option value="1" <?php if($output['activity']['activity_type']=='1'){?>selected<?php }?>>展示</option>
              <option value="2" <?php if($output['activity']['activity_type']=='2'){?>selected<?php }?>>特价</option>
            </select></td>
          <td class="vatop tips"><?php echo $lang['activity_new_type_tip'];?> ，其中“展示” 表示商家提供可展示的商品，“特价”表示商家提供调整价格和库存进行特卖的商品</td>
        </tr>
        <tr>
