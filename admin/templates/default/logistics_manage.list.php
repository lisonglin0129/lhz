...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>物流订单管理</h3>
      <ul class="tab-base">
      <li><a href="index.php?act=logistics&op=logistics_manage" class="current"><span><?php echo '待处理运单';?></span></a></li>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="op" value="logistics_manage" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><a href="index.php?act=logistics&op=edit_logistics&order_id=<?php echo $val['order_id']; ?>"> 编辑 </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
