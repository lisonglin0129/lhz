    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <th><label for="search_commonid">商品条形码</label></th>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          <th class="w24"></th>
          <th class="w24"></th>
          <th class="w60 align-center">商品条形码</th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center"><?php echo $v['goods_barcode'];?> </td>
          ...
          <dl class="goods-info"><dt class="goods-name"><?php echo $v['goods_name'];?></dt>
             <dd class="goods-type">
                ...
                <?php if ($v['is_appoint'] ==1) {?><span class="appoint" title="预约销售提示商品">预约</span><?php }?>
				 <?php if ($v['is_credit'] ==1) {?><span class="credit" title="可以赊账">可赊账</span><?php }?>
             </dd>
