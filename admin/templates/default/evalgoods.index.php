    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
		  ...
		  <th><label for="geval_scores">评价分数</label></th>
          <td><select name="geval_scores">
		      <option value=" "  >所有</option>
              <option value="1" <?php if($_GET['geval_scores']=='1'){?>selected<?php }?>>一星</option>
              <option value="2" <?php if($_GET['geval_scores']=='2'){?>selected<?php }?>>二星</option>
			   <option value="3" <?php if($_GET['geval_scores']=='3'){?>selected<?php }?>>三星</option>
			   <option value="4" <?php if($_GET['geval_scores']=='4'){?>selected<?php }?>>四星</option>
			   <option value="5" <?php if($_GET['geval_scores']=='5'){?>selected<?php }?>>五星</option>
              </optgroup>
            </select> </td>
