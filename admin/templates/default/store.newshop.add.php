  ...
  <form id="store_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
		...
		<tr>
          <td colspan="2" class="required"><label class="validation" for="licence_number">店主身份证号:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" id="licence_number" name="licence_number" class="txt" /></td>
          <td class="vatop tips"></td>
        </tr>
		<tr>
          <td colspan="2" class="required"><label class="validation" for="business_licence_number">店主营业执照号:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" id="business_licence_number" name="business_licence_number" class="txt" /></td>
          <td class="vatop tips"></td>
        </tr>
...
$(function(){
	...
	business_licence_number: {
        ...
        messages : {
			...
			licence_number : {
                required : '<i class="icon-exclamation-sign"></i>请输入正确的身份证号码',
			    isIdCardNo: '<i class="icon-exclamation-sign"></i>请正确输入您的身份证号码'
            },
		business_licence_number: {
                required : '<i class="icon-exclamation-sign"></i>请输入正确的工商营业执照号码'
             },
            seller_name: {
                required : '请输入店主卖家账号',
