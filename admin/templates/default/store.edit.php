...
<td class="vatop tips"></td>
		...
		<tr>
			<td width="70%">
				...
				<div class="onoff" style="float:left;margin-right:10px;">
					<label for="store_creditcard1" class="cb-enable <?php if($output['store_array']['store_creditcard'] == '1'){ ?>selected<?php } ?>" ><span>支持</span></label>
					<label for="store_creditcard0" class="cb-disable <?php if($output['store_array']['store_creditcard'] == '0'){ ?>selected<?php } ?>" ><span>信用卡</span></label>
					<input id="store_creditcard1" name="store_creditcard" <?php if($output['store_array']['store_creditcard'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">
					<input id="store_creditcard0" name="store_creditcard" <?php if($output['store_array']['store_creditcard'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">
				</div>
				<div class="onoff" style="float:left;margin-right:10px;">
					<label for="store_debt1" class="cb-enable <?php if($output['store_array']['store_debt'] == '1'){ ?>selected<?php } ?>" ><span>赊账</span></label>
					<label for="store_debt0" class="cb-disable <?php if($output['store_array']['store_debt'] == '0'){ ?>selected<?php } ?>" ><span>服务</span></label>
					<input id="store_debt1" name="store_debt" <?php if($output['store_array']['store_debt'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">
					<input id="store_debt0" name="store_debt" <?php if($output['store_array']['store_debt'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">
				</div>
			</td>
		</tr>
		<tr>
