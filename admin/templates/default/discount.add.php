  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td colspan="2">
          	<label id='title1' class="validation" for="activity_title">优惠金额:</label>
          	</td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
          ...
          <td  id='title_warning' class="vatop tips">金额0~9999</td>
        </tr>
       <!--  <tr class="noborder">
          <td colspan="2">
       ...
       <tr class="noborder">
          <td colspan="2">
          	<label class="validation" for="activity_title">交易金额:</label>
          	</td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
          ...
          <td class="vatop tips">购买商品累计金额下限达到0已经上</td>
        </tr> 
        <tr class="noborder">
          	<td colspan="2">
        ...
        <tr>
          <td colspan="2" class="required"><label for="activity_sort">审核状态:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff">
          	<label for="activity_state1" class="cb-enable selected" ><span>通过</span></label>
            <label for="activity_state0" class="cb-disable"><span>未通过</span></label>
...
$(function(){$("#submitBtn").click(function(){
	    if($("#add_form").valid()){
		    var max_value = get.Id("min_amount").value;
		    var amount = get.Id("amount").value;
	    	if(get.Name('waybill_express')[0].value == 1) {
		        if(max_value > amount) {
	       			$("#add_form").submit();
		        }else {
		        	$("#add_form").submit();
...
get.Name('waybill_express')[0].onchange = function()
{
	if(this.value == 1)
	{
		set.html(get.Id("title1"),'金额:');
		set.html(get.Id("title_warning"),'折扣0~9999');
	}else if(this.value == 2)
	{
		set.html(get.Id("title1"),'折扣:');
		set.html(get.Id("title_warning"),'折扣0~1');
	}
}
