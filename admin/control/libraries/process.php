...
class process{
	...
	const MAX_LOGIN = 200;	//密码连续输入多少次被暂时锁定
	const MAX_COMMIT = 60;	//连续评论多少次被暂时锁定
	const MAX_REG = 2000;		//连续注册多少个账号被暂时锁定
	const MAX_FORGET =100;	//找回密码输入多少次被暂时锁定
	const MAX_ADMIN = 200;	//后台管理员输入多少次被暂时锁定
