	...
	public function recharge_editOp(){
		...
		if (!chksubmit()) {
		    ...
		    foreach ($payment_list as $key => $value){
				if ($value['payment_code'] == 'predeposit' || $value['payment_code'] == 'offline'|| $value['payment_code'] == 'creditpay') {
		...
		if(!$payment_info || $payment_info['payment_code'] == 'predeposit' || $payment_info['payment_code'] == 'offline'|| $payment_info['payment_code'] == 'creditpay') {
